...
public class ProgramTest {
    ...
    private static InputStreamBuilder stream=StubbedInputStream.stubInputStream();
    ...
    public void show_the_name_of_the_library() throws IOException {
        ...
        System.setIn(stream.toReturn(EXIT_CODE).atSomePoint());
    ...
    public void show_the_books_available_for_rental() throws IOException {
        ...
        System.setIn(stream.toReturn(BOOK_LISTING).then(EXIT_CODE).atSomePoint());
    ...
    public void check_out_a_book() {
        ...
        System.setIn(stream.toReturn(CHECK_OUT_BOOK).then("2").then(EXIT_CODE).atSomePoint());
    ...
    public void check_out_a_book_that_isnt_available() {
        ...
        System.setIn(stream.toReturn(CHECK_OUT_BOOK).then("7").then(EXIT_CODE).atSomePoint());
    ...
    public void talk_to_librarian() {
        ...
        System.setIn(stream.toReturn(TALK_TO_LIBRARIAN).then(EXIT_CODE).atSomePoint());
    ...
    public void invalid_entry() {
        ...
        System.setIn(stream.toReturn("a").then(EXIT_CODE).atSomePoint());
    ...
    public void show_movie_listing() {
        ...
        System.setIn(stream.toReturn(MOVIE_LISTING).then(EXIT_CODE).atSomePoint());
    ...
    public void successfull_log_in() {
        ...
        System.setIn(stream.toReturn(LOGIN).then("111-1111").then("bhaisahab")
    ...
    public void unsuccessful_login_because_of_username() {
        ...
        System.setIn(stream.toReturn(LOGIN).then("999999-1111").then("bhaisahab")
                .then(TALK_TO_LIBRARIAN).then(EXIT_CODE).atSomePoint());
    ...
    public void unsuccessful_login_because_of_password() {
        ...
        System.setIn(stream.toReturn(LOGIN).then("111-1111").then("disrespectfulPassword")
                .then(TALK_TO_LIBRARIAN).then(EXIT_CODE).atSomePoint());
