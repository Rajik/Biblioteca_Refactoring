...
//import static StubbedInputStream.stubInputStream;
...
public class StubbedInputStreamTest {
    ...
    public void should_let_us_choose_values_in_input_stream() throws IOException {
        StubbedInputStream inputStream = StubbedInputStream.stubInputStream().toReturn("9").then("1").then("3").atSomePoint();
    ...
    public void should_let_us_have_inputs_of_more_than_one_character() throws IOException {
        StubbedInputStream inputStream = StubbedInputStream.stubInputStream().toReturn("mark").atSomePoint();
    ...
    public void fluentInterface() {
        StubbedInputStream.stubInputStream().toReturn("9").then("1").atSomePoint();
    }
}
